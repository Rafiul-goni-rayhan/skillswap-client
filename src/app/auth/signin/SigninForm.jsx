...
import { authClient } from "@/lib/auth-client"; // নিশ্চিত করুন এই ফাইলে baseURL: localhost:5000 দেওয়া আছে
...
//   // রোল অনুযায়ী পেজে রিডাইরেক্ট করার কমন ফাংশন
//   const handleRoleRedirect = (user) => {
//     // Better-Auth এর কাস্টম ফিল্ড বা ইউজার রোল চেক
//     const userRole = user?.role?.toLowerCase();
...
//   // ১. Better-Auth এর মাধ্যমে নরমাল ইমেইল/পাসওয়ার্ড দিয়ে Sign In
//   const handleSubmit = async (e) => {
//     e.preventDefault();
//     setError("");
//     setLoading(true);
...
//       // যদি আপনার এক্সিস্টিং প্রজেক্টের অন্য কোথাও লোকাল স্টোরেজের ইউজার ডাটা লাগে
//       if (data && data.user) {
//         localStorage.removeItem("user");
//         localStorage.setItem("user", JSON.stringify(data.user));
//         handleRoleRedirect(data.user);
...
//   // ২. Better-Auth এর মাধ্যমে Google OAuth লগইন
//   const handleGoogleLogin = async () => {
//     setError("");
//     setGoogleLoading(true);
//     try {
//       await authClient.signIn.social({
//         provider: "google",
//         // গুগল দিয়ে সাকসেসফুলি অথেনটিকেশন হয়ে ব্যাক করার পর যে রুটে হিট করবে।
//         // সোশ্যাল লগইনের ক্ষেত্রে সাধারণত রুটে ব্যাক করিয়ে মিডলওয়্যার বা লেআউট দিয়ে রোল চেক করা ভালো
//         callbackURL: "/dashboard", 
//       });
//     } catch (err) {
//       console.error("Better-Auth Google Login Error:", err);
